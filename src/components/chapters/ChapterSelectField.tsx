...
export type ChapterSelectOption = {
  value: string;
  label: string;
  accentColor?: string | null;
};

type ChapterSelectFieldProps = {
  label: string;
  name: string;
  options: readonly ChapterSelectOption[];
  defaultValue?: string;
  value?: string;
...
/** Form chapter picker with dark dropdown rows and a 2px accent stripe on the right. */
