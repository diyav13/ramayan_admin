...
/**
 * Image picker for Information Management entities.
...
export function InfoImageField({
  ...
  const emptyClass =
    variant === "portrait"
      ? "flex h-28 w-24 flex-col items-center justify-center gap-1.5 rounded-lg border border-dashed border-white/15 bg-[var(--surface)] text-center outline-none transition hover:border-white/25 hover:bg-white/5 focus-visible:ring-1 focus-visible:ring-[var(--gold)]"
      : "flex h-24 w-36 flex-col items-center justify-center gap-1.5 rounded-lg border border-dashed border-white/15 bg-[var(--surface)] text-center outline-none transition hover:border-white/25 hover:bg-white/5 focus-visible:ring-1 focus-visible:ring-[var(--gold)]";
